    ...
    <section class="mb-32">
      ...
      <div class="container px-6 md:px-12">
        <div
          ...
          <div class="mb-12 grid gap-x-6 md:grid-cols-3 lg:grid-cols-3">
            <div class="mx-auto mb-12 text-center lg:mb-0">
              ...
              <h6 class="font-medium">Icalma, Region de la Araucania, Chile</h6>
            </div>
            ...
            <div class="mx-auto mb-6 text-center md:mb-0">
              ...
              <h6 class="font-medium">megaavalancheicalma@gmail.com</h6>
            </div>
            <div class="mx-auto mb-6 text-center md:mb-0">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-primary dark:text-primary-400">
              ...
              <h6 class="font-medium">+56935739243</h6>
            </div>
          </div>
          ...
          <div class="hidden mx-auto max-w-[700px]">
            <form>
